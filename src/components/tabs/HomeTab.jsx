  ...
  return (
    <div className="space-y-6 animate-fade-in text-right">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-3xl border border-gray-100/50 shadow-sm flex items-center justify-between text-right cursor-pointer hover:border-brand-purple/20 transition duration-200" onClick={() => navigate('/dashboard/supervisor?tab=institutions')}>
          <div className="space-y-1">
        ...
        <div className="bg-white p-5 rounded-3xl border border-gray-100/50 shadow-sm flex items-center justify-between cursor-pointer hover:border-brand-purple/20 transition duration-200 text-right" onClick={() => navigate('/dashboard/supervisor?tab=applications')}>
          <div className="space-y-1">
        ...
        <div className="bg-white p-5 rounded-3xl border border-gray-100/50 shadow-sm flex items-center justify-between cursor-pointer hover:border-brand-purple/20 transition duration-200 text-right" onClick={() => navigate('/dashboard/supervisor?tab=reports')}>
          <div className="space-y-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-5 rounded-3xl border border-gray-100/50 shadow-sm flex flex-col justify-between text-right">
          <div>
            <div className="flex items-center justify-between mb-4 border-b border-gray-50 pb-3">
              ...
              {/* <button
                ...
                className="px-3.5 py-1.5 bg-brand-purple text-white text-[10px] font-bold rounded-xl hover:bg-brand-purpleDark transition active:scale-95 cursor-pointer font-cairo"
              >
                إضافة مهمة
              </button> */}
            </div>
          ...
          <button
            onClick={() => navigate('/dashboard/supervisor?tab=applications')}
